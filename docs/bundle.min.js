...
},{"browserify-css":14}],19:[function(require,module,exports){
$(document).ready(function(){function t(t){var e=[];return void 0!==t&&(e=_.uniq(_.difference((""+t.toLowerCase()).split(/[^a-zA-ZäüöÄÜÖß']+/),c)),e=_.filter(e,function(t){return t.length>1})),e}function e(t){var e=[];return textOnly=t.val(),void 0!==textOnly&&(e=_.difference((""+textOnly.toLowerCase()).split(/[^a-zA-ZäüöÄÜÖß]+/),c),e=_.filter(e,function(t){return t.length>1}),e=_.uniq(_.flatten(_.filter(_.groupBy(e),function(t){return t.length>1})))),e}function l(t,e,l,s){var n=t.val().length;e.html(l+" &lt; <strong>"+n+"</strong> &lt; "+s+" Chars"),n<l?(e.addClass("lengthLow"),e.removeClass("lengthOk"),e.removeClass("lengthHight")):n>s?(e.addClass("lengthHigh"),e.removeClass("lengthLow"),e.removeClass("lengthOk")):(e.addClass("lengthOk"),e.removeClass("lengthLow"),e.removeClass("lengthHigh"))}function s(t,e,l){$("#serp-title-test").html(t);var s=document.getElementById("serp-title-test");return s.style.fontSize=e,s.style.fontFamily=l,s.clientWidth}function n(t,e,l,n,i,r){var a=s(t.val(),i,r);e.html(l+" &lt; <strong>"+a+"</strong> &lt; "+n+" Pixels"),a<l?(e.addClass("lengthLow"),e.removeClass("lengthOk"),e.removeClass("lengthHight")):a>n?(e.addClass("lengthHigh"),e.removeClass("lengthLow"),e.removeClass("lengthOk")):(e.addClass("lengthOk"),e.removeClass("lengthLow"),e.removeClass("lengthHigh"))}function i(t,e,l,s){var n=t.val().split(/[^\wöäüÖÄÜß]+/).length-1,i=s>-1?s:"unlimited";e.html(l+" &lt; <strong>"+n+"</strong> &lt; "+i+" Words"),n<l?(e.addClass("lengthLow"),e.removeClass("lengthOk"),e.removeClass("lengthHight")):n>s?(e.addClass("lengthHigh"),e.removeClass("lengthLow"),e.removeClass("lengthOk")):(e.addClass("lengthOk"),e.removeClass("lengthLow"),e.removeClass("lengthHigh"))}function r(e,l){var s=t(e.val()),n=t(l.val());return _.difference(s,n)}function a(e,l){var s=t(e.val()),n=t(l.val());return _.intersection(s,n)}function o(t,e,l,s){var n=t.attr("id"),i=r(t,e),o=a(t,e),d="";if(i.length>0&&(void 0===s||void 0!==s&&o.length<s)){var h=0===i.length?"":'<span class="qualityNok">'+i.join(" ")+"</span> ",g="";void 0!==s&&(g=" [Minimum keywords: "+s+"]"),d='<div class="row"><div class="col-xs-12">Missing '+n+" keyword(s): "+h+g+"</div></div>"}l.append(d),l.children().length<1&&l.append('<div class="row"><div class="col-xs-12">&nbsp;</div></div>')}function d(t,l){var s=(t.attr("id"),e(t)),n="";if(s.length>0){var i='<span class="qualityNok">'+s.join(" ")+"</span> ";n='<div class="row"><div class="col-xs-12">Repeated word: '+i+"</div></div>"}l.append(n),l.children().length<1&&l.append('<div class="row"><div class="col-xs-12">&nbsp;</div></div>')}function h(){ga("send",{hitType:"event",eventCategory:"SeoTextEditor",eventAction:"Edit"});var t=570,e=18,r="arial, sans-serif",a=915,h="arial, sans-serif",g=13;if($("#title-quality").html(""),$("#description-quality").html(""),$("#h1-quality").html(""),$("#text-quality").html(""),n($("#title"),$("#title-length"),450,t,e,r),n($("#description"),$("#description-length"),700,a,g,h),l($("#h1"),$("#h1-length"),80,120),i($("#text"),$("#text-length"),1e3,-1),o($("#title"),$("#text"),$("#text-quality")),o($("#description"),$("#text"),$("#text-quality"),3),o($("#h1"),$("#text"),$("#text-quality")),d($("#title"),$("#title-quality")),$("#title").val().length>0){for(var v,c=$("#title").val(),u=s(c,e,r);u>t;)v=c.lastIndexOf(" "),c=c.substr(0,v)+"&nbsp;<strong>...</strong>",u=s(c,e,"arial, sans-serif");$("#serp-title").html(c)}else $("#serp-title").html("Write Title Tags that Describe the Content");if($("#description").val().length>0){for(var v,c=$("#description").val(),u=s(c,g,"arial, sans-serif");u>a;)v=c.lastIndexOf(" "),c=c.substr(0,v)+"&nbsp;<strong>...</strong>",u=s(c,g,"arial, sans-serif");$("#serp-desc").html(c)}else $("#serp-desc").html("Use meta descriptions to describe your page content. Google uses relevant meta descriptions to create the snippet that describes your page in SERP listings.");$("#url").val().length>0?$("#serp-url").html($("#url").val()):$("#serp-url").html("www.example.com/")}var g=require("./stopwords-de"),v=require("./stopwords-en"),c=v.concat(g);$("#title, #url, #description, #h1, #text").keyup(_.debounce(function(t){h()},500)),$("#text").keyup()});

},{"./stopwords-de":21,"./stopwords-en":22}],20:[function(require,module,exports){
require("../css/index.css"),$=jQuery=require("jquery"),_=require("underscore"),require("bootstrap"),require("./controller.js"),Medium=require("medium.js");
},{"../css/index.css":18,"./controller.js":19,"bootstrap":1,"jquery":15,"medium.js":16,"underscore":17}],21:[function(require,module,exports){
