...
function nodeIsNotInsideAnchorTag(e){return!MediumEditor.util.getClosestTag(e,"a")}var AutoStyleExtension=MediumEditor.Extension.extend({config:[{matchcase:!1,wordsonly:!1,styles:[{style:"background-color:yellow;",words:["yellow"]},{style:"background-color:gray;",words:["gray","grey"]}]},{matchcase:!0,wordsonly:!0,styles:[{style:"color:red;",words:["RED"]},{style:"background-color:orange;",words:["oraNGE"]}]}],regexColors:[],init:function(){MediumEditor.Extension.prototype.init.apply(this,arguments),this.disableEventHandling=!1;for(var e=0;e<this.config.length;e++)for(var t=this.config[e],r=t.matchcase===!0?"g":"gi",i=t.wordsonly===!0?"\\b":"",n=0;n<t.styles.length;n++){var o=t.styles[n].style,l=i+t.styles[n].words.join("|")+i,s=new RegExp(l,r);this.regexColors.push({style:o,regex:s})}this.subscribe("editableKeypress",this.onKeypress.bind(this)),this.subscribe("editableBlur",this.onBlur.bind(this))},onBlur:function(e,t){this.performLinking(t)},onKeypress:function(e){this.disableEventHandling||MediumEditor.util.isKey(e,[MediumEditor.util.keyCode.SPACE,MediumEditor.util.keyCode.ENTER])&&(clearTimeout(this.performLinkingTimeout),this.performLinkingTimeout=setTimeout(function(){try{var t=this.base.exportSelection();this.performLinking(e.target)&&this.base.importSelection(t,!0)}catch(e){window.console&&window.console.error("Failed to perform Styleing",e),this.disableEventHandling=!0}}.bind(this),0))},performLinking:function(e){var t=MediumEditor.util.splitByBlockElements(e),r=!1;0===t.length&&(t=[e]);for(var i=0;i<t.length;i++)r=this.removeObsoleteAutoStyleSpans(t[i])||r,r=this.performStyleingWithinElement(t[i])||r;return this.base.events.updateInput(e,{target:e,currentTarget:e}),r},removeObsoleteAutoStyleSpans:function(e){if(!e||3===e.nodeType)return!1;for(var t=e.querySelectorAll('span[data-auto-style="true"]'),r=!1,i=0;i<t.length;i++){var n=t[i].textContent;if(n.indexOf("://")===-1&&(n=MediumEditor.util.ensureUrlHasProtocol(n)),t[i].getAttribute("data-href")!==n&&nodeIsNotInsideAnchorTag(t[i])){r=!0;var o=n.replace(/\s+$/,"");if(t[i].getAttribute("data-href")===o){var l=n.length-o.length,s=MediumEditor.util.splitOffDOMTree(t[i],this.splitTextBeforeEnd(t[i],l));t[i].parentNode.insertBefore(s,t[i].nextSibling)}else MediumEditor.util.unwrap(t[i],this.document)}}return r},splitTextBeforeEnd:function(e,t){for(var r=this.document.createTreeWalker(e,NodeFilter.SHOW_TEXT,null,!1),i=!0;i;)i=null!==r.lastChild();for(var n,o,l;t>0&&null!==l;)n=r.currentNode,o=n.nodeValue,o.length>t?(l=n.splitText(o.length-t),t=0):(l=r.previousNode(),t-=o.length);return l},performStyleingWithinElement:function(e){for(var t=this.findStyleableText(e),r=!1,i=0;i<t.length;i++){var n=MediumEditor.util.findOrCreateMatchingTextNodes(this.document,e,t[i]);this.shouldNotStyle(n)||this.createAutoStyle(n,t[i].style)}return r},shouldNotStyle:function(e){for(var t=!1,r=0;r<e.length&&t===!1;r++)t=!!MediumEditor.util.traverseUp(e[r],function(e){return"a"===e.nodeName.toLowerCase()||e.getAttribute&&"true"===e.getAttribute("data-auto-style")});return t},findStyleableText:function(e){for(var t=e.textContent,r=null,i=[],n=0;n<this.regexColors.length;n++)for(var o=this.regexColors[n],l=o.style,s=o.regex;null!==(r=s.exec(t));){var u=!0,a=r.index+r[0].length;u&&i.push({style:l,start:r.index,end:a})}return i},createAutoStyle:function(e,t){var r=this.document.createElement("span"),i=this.document.createElement("span");for(MediumEditor.util.moveTextRangeIntoElement(e[0],e[e.length-1],r),r.setAttribute("style",t),r.insertBefore(i,r.firstChild),i.setAttribute("data-auto-style","true");r.childNodes.length>1;)i.appendChild(r.childNodes[1])}});try{module.exports=AutoStyleExtension}catch(e){}
},{}],2:[function(require,module,exports){
"use strict";function refreshDeviceInfo(){var e,t,n="deviceInfo",i="XS: 0..767",d="innerWidth",o="innerHeight",r=document.getElementById(n);"innerWidth"in window||(d="clientWidth",o="clientHeight",window=document.documentElement||document.body),e=window[d],t=window[o],r||(r=document.createElement("div"),r.setAttribute("id",n),r.setAttribute("style","position:fixed; right:0px; bottom: 0px; padding:10px; z-index:9999;background:rgba(0,255,0,0.6)"),r.setAttribute("class","hidden-print"),document.body.insertBefore(r,document.body.firstChild)),e>=1200?i="LG: 1200..∞":e>=992?i="MD: 992..1199":e>=768&&(i="SM: 768..991"),i="<b>"+i+" width</b><br/>width: "+e+" height: "+t,r.innerHTML=i}document.addEventListener("DOMContentLoaded",function(e){refreshDeviceInfo(),window.addEventListener?window.addEventListener("resize",refreshDeviceInfo,!1):window.attachEvent?window.attachEvent("onresize",refreshDeviceInfo):window.onresize=refreshDeviceInfo});try{exports=module.exports=function(){}}catch(e){}
...
},{"select":27}],18:[function(require,module,exports){
...
},{"./clipboard-action":17,"good-listener":24,"tiny-emitter":28}],19:[function(require,module,exports){
...
},{"component-matches-selector":20,"matches-selector":20}],20:[function(require,module,exports){
...
},{"component-query":21,"query":21}],21:[function(require,module,exports){
...
},{"component-closest":19}],23:[function(require,module,exports){
