...
var XRegExp=require("xregexp"),AutoStyleExtension=MediumEditor.Extension.extend({config:{sectionA:{matchcase:!1,wordsonly:!1,class:"red-border",words:["yellöw"]},sectionB:{matchcase:!0,wordsonly:!0,style:"color:green;background-color:red;",words:["RED"]},sectionC:{matchcase:!1,wordsonly:!1,style:"background-color:gray;",words:["gray","grey"]},sectionD:{matchcase:!0,wordsonly:!0,style:"background-color:orange;",words:["oraNGE"]}},setConfig:function(t){this.config=t},getConfig:function(){return this.config},removeConfigSection:function(t){delete this.config[t],this.processConfig()},setConfigSection:function(t,e){e.words&&e.words.length>0&&(this.config[t]=e,this.processConfig())},processConfig:function(){this.regexColors=[];for(var t=Object.keys(this.config),e=0;e<t.length;e++){var i=t[e],o=this.config[i],n=o.matchcase===!0?"g":"gi",r=o.wordsonly===!0?["(^|\\PL)","(\\PL|$)"]:["",""],s=r[0]+"("+o.words.join("|")+")"+r[1];this.regexColors.push({style:o.style,clazz:o.class,regex:new XRegExp(s,n)})}},applyStyles:function(){this.getEditorElements().forEach(function(t){var e=this.base.exportSelection();this.performStyling(t);this.base.importSelection(e,!0)},this)},disableEventHandling:void 0,regexColors:[],init:function(){MediumEditor.Extension.prototype.init.apply(this,arguments),void 0===this.disableEventHandling&&(this.disableEventHandling=!1),this.processConfig(),this.applyStyles(),this.subscribe("editableKeypress",this.onKeypress.bind(this)),this.subscribe("editableBlur",this.onBlur.bind(this))},onBlur:function(t,e){this.disableEventHandling||this.performStyling(e)},onKeypress:function(t){this.disableEventHandling||MediumEditor.util.isKey(t,[MediumEditor.util.keyCode.TAB,MediumEditor.util.keyCode.DELETE,MediumEditor.util.keyCode.SPACE,MediumEditor.util.keyCode.ENTER])&&(clearTimeout(this.performStylingTimeout),this.performStylingTimeout=setTimeout(function(){try{var e=this.base.exportSelection();this.performStyling(t.target)&&this.base.importSelection(e,!0)}catch(t){window.console&&window.console.error("Failed to perform styling",t),this.disableEventHandling=!0}}.bind(this),0))},performStyling:function(t){var e=MediumEditor.util.splitByBlockElements(t),i=!1;0===e.length&&(e=[t]);for(var o=0;o<e.length;o++)i=this.unwrapAutoStyleSpans(e[o])||i,i=this.performStylingWithinElement(e[o])||i;return this.base.events.updateInput(t,{target:t,currentTarget:t}),i},unwrapAutoStyleSpans:function(t){if(!t||3===t.nodeType)return!1;for(var e=t.querySelectorAll('span[data-auto-style="true"]'),i=!1,o=0;o<e.length;o++)MediumEditor.util.unwrap(e[o],this.document),i=!0;return i},performStylingWithinElement:function(t){for(var e=this.findStyleableText(t),i=!1,o=0;o<e.length;o++){var n=MediumEditor.util.findOrCreateMatchingTextNodes(this.document,t,e[o]);this.createAutoStyle(n,e[o].style,e[o].clazz)}return i},findStyleableText:function(t){var e=t.textContent.trim(),i=null,o=[];if(e.length>0)for(var n=0;n<this.regexColors.length;n++)for(var r=this.regexColors[n],s=r.style,l=r.clazz,a=r.regex,d=0;null!==(i=XRegExp.exec(e,a,d));)if(d=i.index+1,2===i.length){var u=i.index+i[0].length;o.push({word:i[0],clazz:l,style:s,start:i.index,end:u})}else if(4===i.length){var c=i.index+i[1].length,g=c+i[2].length;o.push({word:i[2],clazz:l,style:s,start:c,end:g})}else window.console&&window.console.error("Cannot process: "+i);return o},createAutoStyle:function(t,e,i){var o=MediumEditor.util.traverseUp(t[0],function(t){var e;return"span"===t.nodeName.toLowerCase()&&t.getAttribute&&"true"===t.getAttribute("data-auto-style")&&(e=t),e});if(o!==!1){if(void 0!==e)if(null===o.getAttribute("style"))o.setAttribute("style",e);else{var n=o.getAttribute("style");o.setAttribute("style",e+";"+n)}void 0!==i&&(o.className+=" "+i),o.setAttribute("data-auto-style","true")}else o=this.document.createElement("span"),MediumEditor.util.moveTextRangeIntoElement(t[0],t[t.length-1],o),void 0!==e&&o.setAttribute("style",e),void 0!==i&&(o.className+=i),o.setAttribute("data-auto-style","true")}});try{window.AutoStyleExtension=AutoStyleExtension}catch(t){}try{module.exports=AutoStyleExtension}catch(t){}
...
var stopwordsDE=require("./stopwords-de"),stopwordsEN=require("./stopwords-en"),stopwords=stopwordsEN.concat(stopwordsDE),EF=require("./medium-editor-factory");EF.init({config:{stopwords:{matchcase:!1,wordsonly:!0,class:"stopword",words:stopwords}},disableEventHandling:!0},["url","title","description","h1","text"]),$(document).ready(function(){function t(t){var e=[];return void 0!==t&&(e=_.uniq(_.difference((""+t.toLowerCase()).split(/[^a-zA-ZäüöÄÜÖß']+/),stopwords)),e=_.filter(e,function(t){return t.length>1})),e}function e(t){var e=[];return textOnly=t.text(),void 0!==textOnly&&(e=_.difference((""+textOnly.toLowerCase()).split(/[^a-zA-ZäüöÄÜÖß]+/),stopwords),e=_.filter(e,function(t){return t.length>1}),e=_.uniq(_.flatten(_.filter(_.groupBy(e),function(t){return t.length>1})))),e}function s(t,e,s,n){var r=t.text().length;e.html('<span class="low">'+s+"</span> &lt; <strong>"+r+'</strong> &lt; <span class="high">'+n+"</span> Chars"),e.removeClass("lengthLow"),e.removeClass("lengthOk"),e.removeClass("lengthHigh"),r<s?e.addClass("lengthLow"):r>n?e.addClass("lengthHigh"):e.addClass("lengthOk")}function n(t,e,s){$("#serp-title-test").html(t);var n=document.getElementById("serp-title-test");return n.style.fontSize=e,n.style.fontFamily=s,n.clientWidth}function r(t,e,s,r,o,l){var i=n(t.text(),o,l);e.html('<span class="low">'+s+"</span> &lt; <strong>"+i+'</strong> &lt; <span class="high">'+r+"</span> Pixels"),e.removeClass("lengthLow"),e.removeClass("lengthOk"),e.removeClass("lengthHigh"),i<s?e.addClass("lengthLow"):i>r?e.addClass("lengthHigh"):e.addClass("lengthOk")}function o(t,e,s,n){var r=t.text().split(/[^\wöäüÖÄÜß]+/).length-1,o=n>-1?n:"unlimited";e.html('<span class="low">'+s+"</span> &lt; <strong>"+r+'</strong> &lt; <span class="high">'+o+"</span> Words"),e.removeClass("lengthLow"),e.removeClass("lengthOk"),e.removeClass("lengthHigh"),r<s?e.addClass("lengthLow"):r>n?e.addClass("lengthHigh"):e.addClass("lengthOk")}function l(e,s){var n=t(e.text()),r=t(s.text());return _.difference(n,r)}function i(e,s){var n=t(e.text()),r=t(s.text());return _.intersection(n,r)}function a(t,e,s,n){var r=l(t,e),o=i(t,e),a=t.attr("id"),d=e.attr("id");EF.setAutoStyle(a,a+"-differ",{matchcase:!1,wordsonly:!0,class:"keyword-missing",words:r}),EF.setAutoStyle(a,a+"-intersect",{matchcase:!1,wordsonly:!0,class:"keyword-present",words:o}),EF.setAutoStyle(d,d+"-intersect",{matchcase:!1,wordsonly:!0,class:"keyword-present",words:o})}function d(t,s){var n=e(t),r=t.attr("id");EF.setAutoStyle(r,r+"-repeated",{matchcase:!1,wordsonly:!0,class:"keyword-repeated",words:n})}function c(){var t=470,e=14,l="arial, sans-serif",i=570,c=18,u="arial, sans-serif",p=915,g="arial, sans-serif",h=13;if(r($("#url"),$("#url-length"),0,t,e,l),r($("#title"),$("#title-length"),450,i,c,u),r($("#description"),$("#description-length"),700,p,h,g),s($("#h1"),$("#h1-length"),15,80),o($("#text"),$("#text-length"),1e3,-1),a($("#title"),$("#text")),a($("#description"),$("#text")),a($("#h1"),$("#text")),d($("#title")),$("#title").text().length>0){for(var f,w=$("#title").text(),x=n(w,c,u);x>i;)f=w.lastIndexOf(" "),w=w.substr(0,f)+"&nbsp;<strong>...</strong>",x=n(w,c,"arial, sans-serif");$("#serp-title").html(w)}if($("#description").text().length>0){for(var f,w=$("#description").text(),x=n(w,h,g);x>p;)f=w.lastIndexOf(" "),w=w.substr(0,f)+"&nbsp;<strong>...</strong>",x=n(w,h,"arial, sans-serif");$("#serp-desc").html(w)}else $("#serp-desc").html("Use meta descriptions to describe your page content. Google uses relevant meta descriptions to create the snippet that describes your page in SERP listings.");if($("#url").text().length>0){for(var w=$("#url").text(),m=w,x=n(w,e,l),y=w.length-1;x>t;)w=m.substring(0,y)+"...",x=n(w,e,l),y--;$("#serp-url").html(w)}else $("#serp-url").html("www.example.com/");EF.applyAutoStyles(),ga("send",{hitType:"event",eventCategory:"SeoTextEditor",eventAction:"Edit"})}function u(t){var e=$("#url").text().trim();if(0===e.length);else if("click"!==t.type&&e===p);else{if(g===!0)return;$("#urlreload").prop("disabled",!0),$.ajax({url:"https://floating-sands-22067.herokuapp.com/?p="+e,beforeSend:function(t){g=!0,p=e,$("#url-spinner").toggle(),$("#url-warning").toggle()},success:function(t){$("#title").text(t.title),$("#description").text(t.description),$("#h1").text(t.h1),$("#text").text(t.text)},error:function(t){$("#url").text(t.statusText)},complete:function(t,e){$("#url-spinner").toggle(),$("#url-warning").toggle(),EF.resetAutoStyles(),c(),g=!1,$("#urlreload").prop("disabled",!1)}})}}$.ajax({url:"https://floating-sands-22067.herokuapp.com/?p=google.de"}),$("#title, #description, #h1, #text").keyup(_.debounce(function(t){c(t)},500)),$("#text").keyup();var p,g=!1;$("#url").keyup(_.debounce(u,2e3)),$("#urlreload").on("click",u);var h=new Clipboard("button.copyToClipboard",{text:function(t){return $(t).parent().find(".editable:first").text()}});h.on("success",function(t){$(t.trigger).toggleClass("copy-status-do copy-status-ok"),setTimeout(function(){$(t.trigger).toggleClass("copy-status-do copy-status-ok")},1e3)})});
